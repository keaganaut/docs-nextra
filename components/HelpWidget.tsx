export const HelpWidget = () => {
  return (
    <section className="relative">
      <div className="fixed top-4 right-4 z-50 flex max-h-[1/3] w-[420px] flex-col rounded-xl bg-gray-200 shadow-md">
        ...
        <div className="space-y-2 p-2">
          ...
          <div className="mb-2 flex w-full flex-col rounded-md border-0 border-gray-400 p-1">
            ...
            <iframe
              margin-top="-120px"
              src="https://scribehow.com/embed/Add_a_source__OtPstF7hRC2Z7mxhQBtgcQ?as=scrollable"
              width="100%"
              height="720"
              allowFullScreen
            ></iframe>
