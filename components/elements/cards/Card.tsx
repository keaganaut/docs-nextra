...
export const Card = ({ icon, title, description, href }: CardProps) => {
  return (
    <Link
      href={href}
      className="card group flex flex-col col-span-12 md:col-span-6 lg:col-span-4 p-6 rounded-lg justify-start overflow-hidden border border-gray-100 dark:border-gray-300"
    >
