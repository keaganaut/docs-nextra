...
**Users:** A set of users and teams that can be provisioned and de-provisioned

**Settings:** Organization-wide settings affecting access control, billing, usability preferences, and beyond

**Spaces:** A set of Y42 spaces in which your users build isolated solutions
...
Space-specific access control settings permit fine-grained permissions
