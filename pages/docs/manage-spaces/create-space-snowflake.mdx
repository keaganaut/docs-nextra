...
<Callout type="info" emoji="ℹ️">
  As a prerequise you need to have a [Y42 organization set-up](
  /docs/organization-setup/create-an-organization) that you have Adminstrator
  rights over.
</Callout>
...
<Image
  src="/asset_library/create_snowflake_account_via_aws_marketplace.png"
  alt="Create new Snowflake account via AWS Marketplace"
  width={1200}
  height={1200}
/>
...
<Image
  src="/asset_library/create_snowflake_space_details.png"
  alt="Provide all Object Storage and DWH credentials"
  width={1200}
  height={1200}
/>
